...
private fun CardContent(name: String) {
    ...
    Row(
        ...
        Column(
            ...
            if (expanded) {
                Text(
                    text = ("Bees make excellent pollinators because most of their life is spent collecting pollen, a source of protein that they feed to their developing offspring.")
                        .repeat(4),
                )
            }
        }
